      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        ...
        <Tabs defaultValue="home" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 bg-white/80 backdrop-blur-sm border border-gray-200 shadow-sm">
            <TabsTrigger value="home" className="data-[state=active]:bg-green-600 data-[state=active]:text-white hover:bg-green-100 hover:text-green-700 transition-colors">
              {t('nav.home')}
            </TabsTrigger>
            <TabsTrigger value="orders" className="data-[state=active]:bg-green-600 data-[state=active]:text-white hover:bg-green-100 hover:text-green-700 transition-colors">
              {t('nav.orders')}
            </TabsTrigger>
            <TabsTrigger value="profile" className="data-[state=active]:bg-green-600 data-[state=active]:text-white hover:bg-green-100 hover:text-green-700 transition-colors">
              Profile
            </TabsTrigger>
          </TabsList>
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <Button variant="outline" size="sm" asChild className="md:ml-auto md:self-start">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 gap-4 text-sm">
                        <div className="p-3 bg-gray-50 rounded-lg">
                          ...
                          <p className="font-medium text-purple-700">{user?.rewardPoints || 0} points</p>
                        </div>
                        <div className="p-3 bg-gray-50 rounded-lg">
                          <p className="text-muted-foreground text-xs">NIC</p>
                          <p className="font-medium">{user?.nic || 'Not provided'}</p>
                        </div>
                      </div>
                    </div>
                  </div>
